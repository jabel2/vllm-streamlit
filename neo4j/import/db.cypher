CREATE CONSTRAINT FOR (node:User) REQUIRE (node.userId) IS UNIQUE;
CREATE CONSTRAINT FOR (node:Category) REQUIRE (node.name) IS UNIQUE;
CREATE CONSTRAINT FOR (node:Review) REQUIRE (node.reviewId) IS UNIQUE;
CREATE CONSTRAINT FOR (node:Business) REQUIRE (node.businessId) IS UNIQUE;
